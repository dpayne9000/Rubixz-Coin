...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s rubixzcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  rubixzcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded rubixzcoin transaction") + "\n" +
              "  rubixzcoin-tx [options] -create [commands]   " + _("Create hex-encoded rubixzcoin transaction") + "\n" +
              "\n";
