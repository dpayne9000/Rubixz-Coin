...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/rubixzcoin-project/rubixzcoin>";
    const std::string URL_WEBSITE = "<https://rubixzcoin.org>";
...
void InitLogging()
{
    ...
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("Rubixzcoin version %s\n", FormatFullVersion());
}
